...
//Modified to include new Searches
import aima.core.search.informed.NewSearch;
import aima.core.search.informed.NewSearch2;
 ...
 */
// Modified by Shane Zabel to include new search
...
public class SearchFactory {
	...
	public final static int NEW_SEARCH = 8;
	public final static int NEW_SEARCH2 = 9;
	...
	public String[] getSearchStrategyNames() {
		return new String[] { "Depth First", "Breadth First",
				...
				"A*", "Recursive Best First", "Hill Climbing", "A* with w of 0.75", "A* with w of 0.25"  };
	}
	 ...
	 *
	 */
	// Modified to include new case and call the new search functions
	public Search createSearch(int strategy, int mode, HeuristicFunction hf) {
		...
		case HILL_SEARCH:
			...
			break;
		// Modified to include HW2 Problem 1.2 case and call that new search function
		case NEW_SEARCH:
			result = new NewSearch(qs, hf);
			break;
		case NEW_SEARCH2:
			result = new NewSearch2(qs, hf);
			break;
		}
		return result;
	}
